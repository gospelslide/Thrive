	...
	<div class="x_panel">
		...
		<div class="x_content">
			<div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="datatable-responsive_wrapper">
				...
				</div><div class="col-sm-6"><div class="dataTables_filter" id="datatable-responsive_filter"><label>Search:<input aria-controls="datatable-responsive" placeholder="" class="form-control input-sm" type="search"></label></div></div></div>
				<div class="row">
					<div class="col-sm-12">
						<table style="width: 100%;" aria-describedby="datatable-responsive_info" role="grid" id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%">
							...
							<tbody>
							@foreach($queue as $trans)
							<?php
							if($trans->status==1)
								$trans->status="Autosweep";
							else
								$trans->status="No Auotsweep";
							?>
                            <tr>
                                <th>{!! $trans->id !!}</th>
...
<div class="row"><div class="col-sm-5"><div aria-live="polite" role="status" id="datatable-responsive_info" class="dataTables_info">Showing 11 to 20 of 57 entries</div></div>
<div class="col-sm-7"><div id="datatable-responsive_paginate" class="dataTables_paginate paging_simple_numbers">
	<ul class="pagination">
		<li id="datatable-responsive_previous" class="paginate_button previous"><a tabindex="0" data-dt-idx="0" aria-controls="datatable-responsive" href="#">Previous</a></li>
		<li class="paginate_button ">
			<a tabindex="0" data-dt-idx="1" aria-controls="datatable-responsive" href="#">1</a></li>
			...
			<li id="datatable-responsive_next" class="paginate_button next"><a tabindex="0" data-dt-idx="7" aria-controls="datatable-responsive" href="#">Next</a></li></ul></div></div></div></div>
